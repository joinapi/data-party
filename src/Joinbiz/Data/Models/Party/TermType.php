...
class TermType extends Model
{
    ...
    {
        return $this->hasMany('Joinbiz\Data\Models\Order\QuoteTerm', 'term_type_id', 'term_type_id');
    }
    ...
    {
        return $this->hasMany('Joinbiz\Data\Models\Order\OrderTerm', 'term_type_id', 'term_type_id');
    }
    ...
    {
        return $this->hasMany('Joinbiz\Data\Models\Accounting\InvoiceTerm', 'term_type_id', 'term_type_id');
    }
    ...
    {
        return $this->hasMany('Joinbiz\Data\Models\Accounting\BillingAccountTerm', 'term_type_id', 'term_type_id');
    }
