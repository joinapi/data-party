 ...
 * @property CommunicationEventPrpTyp $communicationEventPrpTyp
 */
class CommunicationEventPurpose extends Model
{
     ...
     * @var string
     */
    protected $table = 'communication_event_purpose';
     ...
     * @return \Illuminate\Database\Eloquent\Relations\BelongsTo
     */
    public function communicationEventPrpTyp()
    {
        return $this->belongsTo('Joinbiz\Data\Models\Party\CommunicationEventPrpTyp', 'communication_event_prp_typ_id', 'communication_event_prp_typ_id');
    }
}
