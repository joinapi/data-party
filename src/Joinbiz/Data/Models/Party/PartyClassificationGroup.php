...
class PartyClassificationGroup extends Model
{
    ...
    {
        return $this->hasMany('Joinbiz\Data\Models\Marketing\SegmentGroupClassification', 'party_classification_group_id', 'party_classification_group_id');
    }
    ...
    {
        return $this->hasMany('Joinbiz\Data\Models\Product\MarketInterest', 'party_classification_group_id', 'party_classification_group_id');
    }
}
