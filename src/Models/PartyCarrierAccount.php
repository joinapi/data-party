 ...
 */
class PartyCarrierAccount extends Model
{
     ...
     * @var string
     */
    protected $table = 'party_carrier_account';

    /**
     * @var array
     */
    protected $fillable = ['thru_date', 'account_number', 'last_updated_stamp', 'last_updated_tx_stamp', 'created_stamp', 'created_tx_stamp'];
