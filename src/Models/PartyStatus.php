 ...
 */
class PartyStatus extends Model
{
    ...
    {
        return $this->belongsTo('Joinbiz\Data\Models\Party\UserLogin', 'change_by_user_login_id', 'user_login_id');
    }
}
