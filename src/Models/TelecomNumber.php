...
class TelecomNumber extends Model
{
    ...
    {
        return $this->hasMany('Joinbiz\Data\Models\Party\ShipmentRouteSegment', 'dest_telecom_number_id', 'contact_mech_id');
    }
    ...
    {
        return $this->hasMany('Joinbiz\Data\Models\Party\ShipmentRouteSegment', 'origin_telecom_number_id', 'contact_mech_id');
    }
    ...
    {
        return $this->hasMany('Joinbiz\Data\Models\Party\Shipment', 'destination_telecom_number_id', 'contact_mech_id');
    }
    ...
    {
        return $this->hasMany('Joinbiz\Data\Models\Party\Shipment', 'origin_telecom_number_id', 'contact_mech_id');
    }
