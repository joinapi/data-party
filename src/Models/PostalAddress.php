...
class PostalAddress extends Model
{
    ...
    {
        return $this->hasMany('Joinbiz\Data\Models\Party\ShipmentRouteSegment', 'dest_contact_mech_id', 'contact_mech_id');
    }
    ...
    {
        return $this->hasMany('Joinbiz\Data\Models\Party\ShipmentRouteSegment', 'origin_contact_mech_id', 'contact_mech_id');
    }
    ...
    {
        return $this->hasMany('Joinbiz\Data\Models\Party\Shipment', 'destination_contact_mech_id', 'contact_mech_id');
    }
    ...
    {
        return $this->hasMany('Joinbiz\Data\Models\Party\Shipment', 'origin_contact_mech_id', 'contact_mech_id');
    }
    ...
    {
        return $this->belongsTo('Joinbiz\Data\Models\Party\Geo', 'country_geo_id', 'geo_id');
    }
    ...
    {
        return $this->belongsTo('Joinbiz\Data\Models\Party\Geo', 'city_geo_id', 'geo_id');
    }
    ...
    {
        return $this->belongsTo('Joinbiz\Data\Models\Party\Geo', 'county_geo_id', 'geo_id');
    }
    ...
    {
        return $this->belongsTo('Joinbiz\Data\Models\Party\GeoPoint', 'geo_point_id', 'geo_point_id');
    }
    ...
    {
        return $this->belongsTo('Joinbiz\Data\Models\Party\Geo', 'municipality_geo_id', 'geo_id');
    }
    ...
    {
        return $this->belongsTo('Joinbiz\Data\Models\Party\Geo', 'postal_code_geo_id', 'geo_id');
    }
    ...
    {
        return $this->belongsTo('Joinbiz\Data\Models\Party\Geo', 'state_province_geo_id', 'geo_id');
    }
